...
async function main () {  
    ...
    const infuraRinkeby = 'https://rinkeby.infura.io/v3/723214be2174443394c198a49ed60a41';

    // Generating bip39 mnemonic
    const mnemonic = mnemonicGenerate();
    // save the mnemonic in a JSON file in your project directory
    // let data = JSON.stringify(mnemonic);
    // fs.writeFileSync('FILE_WITH_MNEMONIC.json', data);
    ...
    const receivingAddress = "DESTINATION_ADDRESSS";

    console.log(web3.utils.toHex( receivingAddress ));
